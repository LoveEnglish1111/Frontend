...
export default function Study({ cards = [], courseTitle = "" }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-sm mt-2">{currentIndex + 1} / {cards.length} | {learnedCount} learned</p>
      </div>
      ...
      <div className="flex justify-between gap-4">
        <button
          ...
          className="px-6 py-2 bg-gray-400 rounded-lg disabled:opacity-50"
        >
          ← Previous
        </button>
        ...
        <button
          ...
          className={`px-6 py-2 rounded-lg ${isLearned ? 'bg-green-500' : 'bg-yellow-400'}`}
        >
