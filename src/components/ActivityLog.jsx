        ...
        <div className="bg-white rounded-2xl border-2 border-border overflow-hidden">
            ...
            <div className="p-6 border-b border-border">
                ...
                <p className="text-sm text-muted-foreground">
                    Recent actions on the platform
                </p>
            </div>
                    ...
                    return (
                        ...
                        >
                            <div className="flex gap-4">
                                {/* Icon */}
                                <div
                                    className={`p-2.5 rounded-lg flex-shrink-0 ${getStatusColor(activity.status)}`}
                                >
                                    <Icon size={18} />
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-start justify-between gap-4 mb-1">
                                        ...
                                        <span
                                            className={`text-xs font-semibold inline-block px-2 py-1 rounded-full flex-shrink-0 ${getStatusColor(activity.status)}`}
                                        >
                                            {activity.status}
                                        </span>
                                    </div>
