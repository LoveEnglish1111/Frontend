    ...
    <div className="min-h-screen w-screen bg-gradient-to-br from-primary-50 to-blue-100 flex items-center justify-center p-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-3xl font-bold text-foreground mb-2 text-center">Create Account</h2>
          <p className="text-center text-muted-foreground text-sm mb-6">Join us and start learning today!</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {errors.terms && (
              <p className="text-sm text-destructive font-medium">{errors.terms}</p>
            )}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white text-muted-foreground font-medium">Or sign up with</span>
            </div>
          </div>
          ...
          <p className="text-center text-muted-foreground font-medium">
            ...
            <Link to="/SignIn" className="text-primary-600 hover:text-primary-700 font-bold">
              Sign In
            </Link>
          </p>
        </div>
